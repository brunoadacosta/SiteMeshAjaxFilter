...
/**
 * A set of static constants of Strings to be used as ServletRequest attribute
 * keys to represent various objects passed between pages.
 * 
...
public interface RequestConstants {
	...
	/**
	 * Stores {@link com.opensymphony.module.sitemesh.Page} instance for parsed
	 * page to be passed across to
	 ...
	 * {@link com.opensymphony.module.sitemesh.taglib.page.ApplyDecoratorTag}
	 * and used by the corresponding
	 * {@link com.opensymphony.module.sitemesh.DecoratorMapper}.
	 */
	String DECORATOR = "__sitemesh__decorator";

	/**
	 * Marker that stores a Boolean (under the session) to state whether the
	 * current session is the session of a web search engine spider. This is set
	 * and used by the
	 ...
	 */
	String AJAX_KEY = "XMLHttpRequest";

	/**
	 * Identify the ajax request parameter.
	 */
	String AJAX_PARAM_KEY = "_ajax";
}