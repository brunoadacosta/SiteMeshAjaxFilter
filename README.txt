Alteração para navegação ajax

* Adicionar o filtro no WEB-INF/web.xml


	<!-- Mapeamento para o SiteMesh customizado para navegação em JSON -->
	<filter>
		<filter-name>AjaxSiteMesh</filter-name>
		<filter-class>com.commons.ajax.sitemesh.AjaxSiteMeshFilter</filter-class>
	</filter>
	<filter-mapping>
		<filter-name>AjaxSiteMesh</filter-name>
